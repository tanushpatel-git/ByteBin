  ...
  return (
    <div className="relative">
      <motion.button
        whileTap={{ scale: 0.93 }}
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-2 hover:bg-[#F3EEE8] rounded-xl px-2 py-1.5 transition-colors"
        aria-expanded={open}
        aria-haspopup="menu"
      ...
      >
        ...
        <ChevronDown size={12} className={cn("text-[#6B7280] transition-transform", open && "rotate-180")} />
      </motion.button>
        ...
        {open && (
          ...
          >
            <div className="px-4 py-3 border-b border-[#F3EEE8]">
              ...
              <p className="text-[11px] text-[#6B7280]">vedan@bytebin.dev</p>
            </div>
            <div className="py-1">
              {[
