          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex-1 bg-white p-8 relative">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                  ...
                  <div className="space-y-1">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 py-2 px-3 hover:bg-[#FBF5EE] rounded-lg cursor-pointer transition-colors group">
                        {item.type === "folder" ? (
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                  <div className="flex flex-col gap-4">
                    {[
                      ...
                      <div key={i} className="flex flex-col p-4 border border-[#ECE3D8] rounded-xl hover:border-[#D3ACFF]/50 transition-colors cursor-pointer group">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-2">
                            <div className={cn(
                              "w-2 h-2 rounded-full",
                              dep.status === "success" ? "bg-green-500" : "bg-red-500"
                            )} />
              ...
              {activeTab === "terminal" && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="h-full">
                  <div className="w-full h-full bg-[#18181B] rounded-xl p-5 font-mono text-[13px] leading-relaxed shadow-inner">
                    ...
                    <div className="text-[#D3ACFF] mt-4 animate-pulse">_</div>
                  </div>
                </motion.div>
              )}
              ...
              {["commits", "prs"].includes(activeTab) && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center h-full text-[#6B7280]">
